...
public class ExcelWriter {
    ...
    contacts.add(new Contacts("Sylvain", "Saurel",
      "sylvain.saurel@gmail.com", "17/01/1980"));
    contacts.add(new Contacts("Albert", "Dupond",
      "sylvain.saurel@gmail.com", "17/08/1989"));
    contacts.add(new Contacts("Pierre", "Dupont",
      "sylvain.saurel@gmail.com", "17/07/1956"));
    contacts.add(new Contacts("Mariano", "Diaz", "sylvain.saurel@gmail.com",
      "17/05/1988"));
    ...
    FileOutputStream fileOut = new FileOutputStream(new File("C:\\\\TempFile\\gfgcontribute.xlsx")); 
